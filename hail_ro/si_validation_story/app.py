from layouts.pages import ch1_si_intake_page, ch2_si_validation_page,si_modification
...
def main():
    ...
    chapter = st.sidebar.selectbox("Choose a chapter", 
                                    ["Ch 1: Shipping Instruction Intake", "Ch 2: Shipping Instruction Validation", "Shipping Instruction Modification"],
    ...
    # SI 수정 페이지 
    elif chapter == "Shipping Instruction Modification":
        si_modification.main()
