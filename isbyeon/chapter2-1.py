...
6. If any required information is missing or incorrectly formatted, mark it as "Invalid".
   for example,
   address1(UNIT 502, 5/F, BUILDING A, NO.123 HONGKOU ROAD, SHANGHAI, CHINA) is not with postal code, so it's invalid.
   address2(3-1-1, MEIJI-DOORI, CHUO-KU, TOKYO, JAPAN) reads nothing of postal code, thus it's invalid.
   address3(ROOM 1501, SUNRISE TOWER, 123 SUNRISE STREET, NINGBO 11111, CHINA) doesn't contain a valid zip code, therefore invalid.
   address4(1-1, SHIBUKAWA 3-CHOME, CHIYODA-KU, TOKYO, JAPAN) is invalid due to the lack of zip code.
